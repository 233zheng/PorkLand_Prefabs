...
local states=
{
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(11*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/move") end ),
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(8*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/attack_pre") end),
            TimeEvent(11*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/attack") end),
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/death")
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/eat_drop") end),
            TimeEvent(12*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/eat") end),
            TimeEvent(24*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/eat_up") end),
            TimeEvent(21*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/enemy/grabbing_vine/eat_drop") end),
