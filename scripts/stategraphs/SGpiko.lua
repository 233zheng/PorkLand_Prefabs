...
local states =
{
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(16*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/piko/idle") end),
            TimeEvent(18*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/piko/idle") end),
            TimeEvent(20*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/piko/idle") end),
        },
    ...
    State{
        ...
        timeline =
        {
            ...
            TimeEvent(2*FRAMES, function(inst) inst.SoundEmitter:PlaySound("pl/creatures/piko/attack")  end),
        },
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            inst.AnimState:PlayAnimation("eat_pre", false)
            inst.SoundEmitter:PlaySound("pl/creatures/piko/steal")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("pl/creatures/piko/death")
