...
local function StopTrackingInSpawner(inst)
    ...
    if TheWorld and TheWorld.components.glowflyspawner then
        TheWorld.components.glowflyspawner:StopTracking(inst)
    end
end
...
local function commonfn(Sim)
    ...
    local function OnChangeSeason(inst, data)
    ...
    inst:ListenForEvent("seasonChange", OnChangeSeason, TheWorld)
...
return Prefab("glowfly", glowflyfn, assets, prefabs)
